 ...
 *
 *
 * Sample output for DNS after 'dig google.com'
 *
 * [93B] 00:15:5d:4f:81:b1 -> 00:15:5d:b1:3b:6d | IP (OUTGOING)
 * 0x0000:  00 15 5d b1 3b 6d 00 15 5d 4f 81 b1 08 00 45 00  ..].;m..]O....E.
 * 0x0010:  00 4f 31 be 00 00 40 11 27 45 ac 1b 69 63 ac 1b  .O1...@.'E..ic..
 * 0x0020:  60 01 83 28 00 35 00 3b 21 e8 8d ba 01 20 00 01  `..(.5.;!.... ..
 * 0x0030:  00 00 00 00 00 01 06 67 6f 6f 67 6c 65 03 63 6f  .......google.co
 * 0x0040:  6d 00 00 01 00 01 00 00 29 10 00 00 00 00 00 00  m.......).......
 * 0x0050:  0c 00 0a 00 08 06 60 75 2d 74 c3 7c c4           ......`u-t.|.
 *
 * [96B] 00:15:5d:b1:3b:6d -> 00:15:5d:4f:81:b1 | IP (INCOMING)
 * 0x0000:  00 15 5d 4f 81 b1 00 15 5d b1 3b 6d 08 00 45 00  ..]O....].;m..E.
 * 0x0010:  00 52 3a 6b 00 00 80 11 de 94 ac 1b 60 01 ac 1b  .R:k........`...
 * 0x0020:  69 63 00 35 83 28 00 3e 69 20 8d ba 81 20 00 01  ic.5.(.>i ... ..
 * 0x0030:  00 01 00 00 00 00 06 67 6f 6f 67 6c 65 03 63 6f  .......google.co
 * 0x0040:  6d 00 00 01 00 01 06 67 6f 6f 67 6c 65 03 63 6f  m......google.co
 * 0x0050:  6d 00 00 01 00 01 00 00 00 00 00 04 ac d9 10 2e  m...............
 *
 */
...
struct sock_filter dns_filter[] = { /** sudo tcpdump -n -s 1500 udp and port 53 -dd **/
        { 0x28, 0, 0, 0x0000000c },
        { 0x15, 0, 6, 0x000086dd },
        { 0x30, 0, 0, 0x00000014 },
